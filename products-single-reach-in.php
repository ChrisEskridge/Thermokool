<?php
/**
Template Name: Products-Single-Reach-In
**/
...
<div class="content-wrap">
            ...
            <div class="left">
            	<div class="story-text3b">
                	<div class="story-box3">
                           ...
                           <div class="slider4" style="background-image:url(<?php bloginfo('template_directory'); ?>/images/head.jpg); background-size:cover; background-position:center;">                     
	...
	<?php while( have_rows('value_repeater') ): the_row(); 
		...
		?>     
                            		...
                            		<img src="<?php bloginfo('template_directory'); ?>/images/check.png" style="width:32px; padding-right:15px; padding-top:5px;">
...
<?php endif; ?>
		...
		<?php if( $post->post_parent == "133") { ?>
			<div id="sidebar-products-container">
				...
				<?php query_posts(array('showposts' => 20, 'post_parent' => "133", 'post_type' => 'page', 'orderby' => 'menu_order', 'order' => 'ASC')); while(have_posts()) : the_post(); ?>
