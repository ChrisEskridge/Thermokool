            	...
            	<div class="story-text3">
                    ...
                    <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
                        ...
                        <div class="story-box-blue">
                        	...
                        	<h2>The internal dimensions of a one-rack custom modular room are:</h2>
                        	Front to back: minimum = 30″, maximum = 40″<br><br>
                            Height: minimum = 81″, maximum = 96″<br><br>
                            Frame depth: minimum = 17″<br><br>
                            <img src="<?php the_field('dimension_image1'); ?>" style="width:200px; padding-right:15px; padding-top:3.5px;">
                            <img src="<?php the_field('dimension_image2'); ?>" style="width:200px; padding-right:15px; padding-top:3.5px;">
                            <img src="<?php the_field('dimension_image3'); ?>" style="width:200px; padding-right:15px; padding-top:3.5px;">
                        
                        </div>
                        
                        <div style="border-top:solid thin #A9A9A9; width:100%;">
                        </div>
                        
                        <div class="story-box-blue">
                        	<h2>The internal dimensions of a two-rack custom modular room are:</h2>
                        	Front to back: minimum = 30″, maximum = 40″<br><br>
                            Height: minimum = 81″, maximum = 96″<br><br>
                            Frame depth: minimum = 17″<br><br>
                            <img src="<?php the_field('dimension_image1b'); ?>" style="width:200px; padding-right:15px; padding-top:3.5px;">
                            <img src="<?php the_field('dimension_image2b'); ?>" style="width:200px; padding-right:15px; padding-top:3.5px;">
                            <img src="<?php the_field('dimension_image3b'); ?>" style="width:200px; padding-right:15px; padding-top:3.5px;">
