...
<div class="content-wrap">
    ...
    <div class="section" style="background-color:#fff; background-image:url(<?php bloginfo('template_directory'); ?>/images/texture.png); background-size:cover;">
    	<div class="shadow">
        </div>
    	<div class="restrictor">
    		...
    		<div class="story-wrap">
                ...
                <?php $paged = ( get_query_var( 'paged' ) ) ? get_query_var( 'paged' ) : 1; ?>
                    		<?php $pub_query = new WP_Query(array( 'post_type' => 'turtletrack', 'posts_per_page' => 9, 'orderby' => 'date', 'order' => 'dsc', 'paged' => $paged)); ?>
            	...
            	<div class="story-text3">
                	...
                	<div class="story-box3">
                    	...
                    	<div class="story-box-pad">
                    		...
                    		<?php $paged = ( get_query_var( 'paged' ) ) ? get_query_var( 'paged' ) : 1; ?>
                    		<?php $pub_query = new WP_Query(array( 'post_type' => 'turtletrack', 'posts_per_page' => 10, 'orderby' => 'date', 'order' => 'dsc', 'paged' => $paged)); ?>
                     
            <?php if( $pub_query->have_posts() ) : 
	while( $pub_query->have_posts() ) : 
	$pub_query->the_post(); ?>              
                          
                 	<!--<a class="turtle-link2" href="http://thermokool.robertscreative.net/wp-content/uploads/TT-MayJune-2016.pdf">
                 		<?php the_title(); ?>
                    </a>    <br>-->
    <!--                    
                     <div class="turtle-link2">
                    	<?php the_content(); ?>
                        </div>
