    	...
    	<div class="restrictor">
            <div class="story-wrap2">
            	<div class="story-text3">
                    ...
                    <?php if( have_rows('group_title_repeater') ): ?>

	
	<?php while( have_rows('group_title_repeater') ): the_row(); 

		// vars
		$title = get_sub_field('group_title');
		$blurb = get_sub_field('group_blurb');
		...
		?> 
						...
						<div style="margin-bottom:30px; font-style:italic; font-size:16px;">
                        <?php echo $blurb; ?>
                        </div>
...
<div style="margin-bottom:35px">
                           ...
                           <?php if( have_rows('individual_repeater') ): ?>

	<?php while( have_rows('individual_repeater') ): the_row(); 
		...
		?>     
                            	...
                            	<div style="font-weight:bold; margin-bottom:7px;"><?php echo $name; ?><br></div>
                                <div style="color:#15a4e6;margin-bottom:7px;"><?php echo $title; ?><br></div>
