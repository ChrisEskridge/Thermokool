    ...
    <div class="restrictor">
    	<div class="story-wrap">
                ...
                <?php $paged = ( get_query_var( 'paged' ) ) ? get_query_var( 'paged' ) : 1; ?>
                    		<?php $pub_query = new WP_Query(array( 'post_type' => 'featured', 'posts_per_page' => 9, 'orderby' => 'date', 'order' => 'dsc', 'paged' => $paged)); ?>
            	...
            	<div class="story-text3">
                	...
                	<div class="story-box3">
                    	...
                    	<div class="story-box-pad">
                    		...
                    		<?php $paged = ( get_query_var( 'paged' ) ) ? get_query_var( 'paged' ) : 1; ?>
                    		<?php $pub_query = new WP_Query(array( 'post_type' => 'featured', 'posts_per_page' => 5, 'orderby' => 'date', 'order' => 'dsc', 'paged' => $paged)); ?>
