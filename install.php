    ...
    <div class="section" style="background-color:#FFFFFF;">
    	...
    	<div class="story-wrap">
                ...
                <?php $paged = ( get_query_var( 'paged' ) ) ? get_query_var( 'paged' ) : 1; ?>
                    		<?php $pub_query = new WP_Query(array( 'post_type' => 'installation', 'posts_per_page' => 9, 'orderby' => 'date', 'order' => 'dsc', 'paged' => $paged)); ?>
...
<!--<div class="content-wrap">
	<div class="section">
    	<div class="slider2" style="background-image:url(<?php bloginfo('template_directory'); ?>/images/head.jpg); background-size:cover; background-position:center;">
            ...
            <div class="crumb">
            	<span style="color:#a2bacb; font-family:fjalla one"></span> <?php echo strtoupper(get_the_title()); ?>
            </div>
        </div>
    </div>
            	...
            	<div class="story-text3">
                	...
                	<div class="story-box3">
                    	...
                    	<div class="story-box-pad">
                    		...
                    		<?php $paged = ( get_query_var( 'paged' ) ) ? get_query_var( 'paged' ) : 1; ?>
                    		<?php $pub_query = new WP_Query(array( 'post_type' => 'installation', 'posts_per_page' => 5, 'orderby' => 'date', 'order' => 'dsc', 'paged' => $paged)); ?>
		...
		<?php // get_sidebar(); ?>
			...
			<div id="sidebar-products-container">
				...
				<div class="table">
                    ...
                    <img src="<?php bloginfo('template_directory'); ?>/images/install-white.png" style="width:50px; padding-right:15px; ">
                    </div>
